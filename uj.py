...
def idteman():
	...
	if i.upper() == 'Y':
		...
		return menu()
def menu():
	cetak("\n           !h.-.-..\n          /+/++//\n         /+/++//\n  !k*   !k* !h/+/++//\n   \ /  |/__//\n !h{!mX!h}v{!mX!h}!0!b|!cSAMA MUHAMAD SYAHPUTRA!b|==========.\n   !h(!m'!h)!0  !h/'|'\           !b\\\n       !h/  \  \          !b'\n       !h\_  \_ \_   !k___!mBRUTEFORCE !celite!k___\n\n !m* !bbruteforce elite\n !m* !csama muhamad syahputra\n !m* !phttps://github.com/muhamad-sama/bruteforce\n !m* !phttps://youtube.com/sama muhamad syahputra\n !m* !pjangan lupa subscrie channel yuotube saya\n!k.======================.\n|!h  AMBIL !mID!h DARI.....  !k|\n'======================'\n!k#!p1 !hDAFTAR TEMAN\n!k#!p2 !hANGGOTA GROUP\n!k#!p3 !mKELUAR...")
